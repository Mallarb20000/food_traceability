"""
Django settings for food_traceability project.
...
SECRET_KEY = 'django-insecure-)!+2re9&0de#^pi*-0)1+t_s@s4m=-5#p=-bv@!f_dayj(y%h$'
...
WSGI_APPLICATION = 'food_traceability.wsgi.application'
